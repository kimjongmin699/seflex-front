...
export const LiveSearch = ({
  ...
  const getInputStyle = () => {
    return inputStyle
      ? inputStyle
      : commonInputClasses + ' border-2 p-1 rounded text-lg'
  }
  ...
  return (
    <div
      ...
      className="relative ontline-none"
    >
      <input
        type="text"
        id={name}
...
const ResultCard = forwardRef((props, ref) => {
  const {
    item,
    renderItem,
    resultConotainerStyle,
    selectedResultStyle,
    onMouseDown,
  } = props
  const getClasses = () => {
    if (resultConotainerStyle)
      return resultConotainerStyle + ' ' + selectedResultStyle
